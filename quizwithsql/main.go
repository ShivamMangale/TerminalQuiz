...
func AddQuestion(db *sql.DB) {
	...
	temp.question = inputval("Question")
	temp.optionA = inputval("Option A")
	temp.optionB = inputval("Option B")
	temp.optionC = inputval("Option C")
	temp.optionD = inputval("Option D")
	temp.correctoption = inputval("Correct Option(a,b,c or d)")
...
func EditQuestion(db *sql.DB) {
	...
	idtoupdate, err := strconv.Atoi(inputval("Enter the id of the question you want to edit. (-1 in case you don not want to edit a question)"))
	if err != nil {
	...
	temp.question = doupdate("Question", temp.question)
	temp.optionA = doupdate("Option A", temp.optionA)
	temp.optionB = doupdate("Option B", temp.optionB)
	temp.optionC = doupdate("Option C", temp.optionC)
	temp.optionD = doupdate("Option D", temp.optionD)
	temp.correctoption = doupdate("Correct Option", temp.correctoption)
